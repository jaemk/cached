/*!
Trybuild compile-fail goldens for the next-major macro changes.
...
- a generic function and a generic `in_impl` method without `key`/`convert` (the
  generic rejection, #80) on both `#[cached]` and `#[concurrent_cached]`.
...
#[test]
fn compile_fail_next_major_macro() {
